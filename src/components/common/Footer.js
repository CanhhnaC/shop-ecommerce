      ...
      <div className="footer_info">
          ...
          <div className="footer_info-col">
            ...
            <div className="signature-container">
              <img className="signature" src="https://cdn11.bigcommerce.com/s-vkxbwye8i2/product_images/uploaded_images/jcn-sig.jpg?t=1589569698&amp;_ga=2.5651571.1394121379.1589291923-174497479.1585605496" alt="Josie Natori signature"/>
          </div>
          </div>
      </div>
      <div className="footer_copyright">
            <ul className="footer_copyright-items">
                <li className="footer_copyright-item">
                    <span className="powered-by">© 2020 Natori All Rights Reserved</span>
                </li>
                <li className="footer_copyright-item">
                    <a className="footer_copyright-link" href="/sitemap/">Sitemap</a>
                </li>
                <li className="footer_copyright_item">
                    <a className="footer_copyright-link" href="/privacy-policy/">Privacy Policy</a>
                </li>
                <li className="footer_copyright-item">
                    <a className="footer_copyright-link" href="/accessibility-statement/">Accessibility Statement</a>
                </li>
            </ul>
        </div>
    </StyleFooter>
